  ...
  return (
    <div
      ...
      className={`
        ...
        ${isDragging ? "border-accent bg-bg" : "border-border bg-bg hover:border-text-muted hover:bg-surface"}
      `}
    ...
    >
      ...
      {preview ? (
        ...
        <div className="flex flex-col items-center justify-center text-text-muted space-y-4 relative z-10">
          <ImageIcon
            className={`w-8 h-8 transition-colors duration-300 ${isDragging ? "text-accent" : "text-text-muted"}`}
          />
